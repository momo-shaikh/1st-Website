...
document.addEventListener("DOMContentLoaded", function() {
  console.log("Parallax Mountains Script Loaded");
  ...
  (function() {
    ...
    parallaxAreaHeight = sketch.height / 1.01; // defines parallax area
    ...
    MountainRange.prototype.render = function() {
      ...
      // Apply parallax effect only if mouse is within the top fourth of the page
  if (sketch.mouse.y < parallaxAreaHeight) {
    // Calculate the parallax effect based on mouse position
    var parallaxEffect = (parallaxAreaHeight - sketch.mouse.y) / 5 * this.layer;
    // Apply the parallax effect
    sketch.translate(0, parallaxEffect);
  }

  // Apply translation for mountain position
